      ...
      {showCaption && active?.title && (
        ...
        >
          ...
          {active.meta && active.meta.length > 0 && (
            <dl className="mt-10 w-full max-w-[280px] text-[12px]">
              {active.meta.map((row) => (
                <div key={row.label} className="flex justify-between py-[5px]">
                  <dt className="text-muted-foreground mr-4">{row.label}</dt>
          ...
          {(active.github || active.live) && (
            <div className="mt-6 flex items-center justify-center gap-4 w-full max-w-[280px]">
              {active.github && (
                <a href={active.github} target="_blank" rel="noreferrer" className="flex-1 py-2 rounded-xl border border-gray-300 text-gray-900 text-center flex justify-center items-center gap-2 hover:bg-gray-100 transition-colors font-semibold text-sm">
                  Code
                </a>
              )}
              {active.live && (
                <a href={active.live} target="_blank" rel="noreferrer" className="flex-1 py-2 rounded-xl bg-blue-600 text-white text-center flex justify-center items-center gap-2 hover:bg-blue-700 transition-colors font-semibold shadow-lg text-sm">
                  Live Demo
                </a>
              )}
            </div>
