...
import { SquareArrowOutUpRight, Code2 } from "lucide-react";
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-4 border-black/10 dark:border-white/10 overflow-hidden shadow-xl bg-gray-900",
          ...
          <div className="flex items-center gap-2 ml-4">
            {activeItem.href ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center p-2 rounded-full bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 transition-colors"
            ...
            {activeItem.github ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center p-2 rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors"
  ...
  return (
    <div className="relative h-full w-full bg-gray-900 group">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        ...
        {item.description ? (
          <div className="mb-4 line-clamp-2 text-sm text-gray-300">
            {item.description}
          </div>
        ) : null}
        ...
        {item.skills && (
          <div className="flex flex-wrap gap-2">
            {item.skills.map((skill, i) => (
              <span key={i} className="px-3 py-1 text-xs font-medium bg-white/20 backdrop-blur-md rounded-full text-white border border-white/10 shadow-sm">
                {skill}
              </span>
            ))}
          </div>
