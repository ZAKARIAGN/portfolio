      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 pb-12 border-b border-gray-800">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/zakaria.gnaoui.148" target="_blank" rel="noreferrer"
              ...
              <a href="https://www.instagram.com/zakaria_gw_/" target="_blank" rel="noreferrer"
              ...
              <a href="https://www.linkedin.com/in/zakaria-gnaoui-749146398/" target="_blank" rel="noreferrer"
              ...
              <a href="https://github.com/ahmed05445" target="_blank" rel="noreferrer"
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © {currentYear} <span className="text-gray-400">Zakaria Gnaoui</span>. All rights reserved.
          </p>
